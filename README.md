# Korean Jaso Analyzer for Elasticsearch 8.15.0 
  (자동완성 플러그인)
...
###### 자동완성용 한글 자소분석기입니다. elasticsearch 8.15.0 에서 테스트 되었습니다
...
###### *설치*
```
bin/elasticsearch-plugin install https://github.com/netcrazy/elasticsearch-jaso-analyzer/releases/download/v8.15.0/jaso-analyzer-plugin-8.15.0-plugin.zip
```
